...
import com.rpn.totel.databinding.ItemNearbyHotelBinding
import com.rpn.totel.model.Booked


class NearbyHotelAdapter : RecyclerView.Adapter<NearbyHotelAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val viewBinding = DataBindingUtil.inflate(
            layoutInflater,
            R.layout.item_nearby_hotel,
            parent,
            false
        ) as ItemNearbyHotelBinding
