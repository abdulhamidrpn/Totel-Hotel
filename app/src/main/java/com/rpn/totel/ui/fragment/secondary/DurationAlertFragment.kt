...
class DurationAlertFragment : Fragment() {

    private var _binding: FragmentDurationAlertBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDurationAlertBinding.inflate(inflater, container, false)
    ...
    fun init() {
        ...
        binding.btnExtendTime.setOnClickListener {
            findNavController().navigate(R.id.globalActionToExtendTimeFragment)
        }
