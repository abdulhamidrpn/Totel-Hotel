...
import com.rpn.totel.databinding.FragmentSpaceBinding
import com.rpn.totel.ui.fragment.secondary.dashboard.space.ClaimsFragment
import com.rpn.totel.ui.fragment.secondary.dashboard.space.ListingsFragment
    ...
    private fun initViewpager(viewPager: ViewPager) {
        val listSortModeAdapter =
            ViewPagerAdapter(childFragmentManager).apply {
                addFragment(ListingsFragment(), "Listings")
                addFragment(ClaimsFragment(), "Claims")
            }
